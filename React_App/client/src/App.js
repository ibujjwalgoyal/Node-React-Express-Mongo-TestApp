...
class App extends Component{
	...
	//changed and implemented those changes into our UI.
	componentDidMount(){
		this.getDataFromDb();
	...
	//just a note, here, in the front end, we use our id key of our data object
	...
	//here is our UI
	//it is reast to understand their functions when you
  ...
  render(){
    ...
    return(
    	<div>
    		<ul>
    			{data.length <= 0 ? 'NO DB ENTRIES YET' 
    			: data.map((dat) => (
    				<li style={{ padding: '10px'}} key={data.message}>
	    				<span style={{ color: 'grey'}}>id: </span> {dat.id} <br/>
